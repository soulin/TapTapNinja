...
//bool beatDetector::process(vectorDelay<doubleVector> mfccStream) {
// bool beatDetector::process() {
//	bool beatDetected = false;
//	mfccFrameDifference = distBetween(&(mfccStream.getFrame()[0]), &(mfccStream.getLastFrame()[0]), 13) * 2;
//	mfccFrameDifference = exp(mfccFrameDifference * 8.0) / exp(8.0);
//	return beatDetected;
//}
