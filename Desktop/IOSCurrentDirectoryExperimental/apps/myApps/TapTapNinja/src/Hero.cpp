...
//draws the hero
void Hero :: drawHero(bool paused){
...
//loadSet is an old variable name when there used to be two sets of images for the left and right side. Now just used one image and mirrors it 
    ...
    if(loadSet == 1){
                                         //size of the image on screen...also the size from the sprite sheet 
        hero.drawSubsection(xPos, yPos , 150, 150, animateX, animateY);
                                                        //this is the location on the sprite sheet
    }else{
                                                //the size of the imgage now flipped in the x axis
        hero.drawSubsection(xPos + 150, yPos , -150, 150, animateX, animateY, 150, 150);
    }                                                      //loaction          //this now is the size of the image on the sprite sheet
