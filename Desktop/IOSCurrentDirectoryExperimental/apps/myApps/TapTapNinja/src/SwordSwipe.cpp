...
void SwordSwipe :: draw(bool paused, float sX, float sY)
{
    ...
    if(enemyId == 1)
    {
        swordImage->drawSubsection(swordX,       swordY*sY,   300 ,150, randomSlash*300 ,slashType*150);
    }
    else
    {
        swordImage->drawSubsection(swordX+(275),   swordY*sY,  -300 ,150, randomSlash*300 ,slashType*150, 300, 150);
    }
